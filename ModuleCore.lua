...
function ArcHUD.modulePrototype:CreateRing(hasBG, parent)
	...
	t:SetTexture("Interface\\AddOns\\TeronArcHUD\\Icons\\Ring.tga")
	t:SetAllPoints(f)
	f.quadrants[1] = t
	...
	t = f:CreateTexture(nil, "ARTWORK")
	t:SetTexture("Interface\\AddOns\\TeronArcHUD\\Icons\\Slice.tga")
	t:SetAllPoints(f)
	f.slice = t
	...
	if(hasBG) then
		...
		t:SetTexture("Interface\\AddOns\\TeronArcHUD\\Icons\\RingBG.tga")
		t:SetAllPoints(fBG)
		fBG.quadrants[1] = t
